...
- Song download and Drive helpers: [`grii_slide_maker.songs.drive.download_new_song_pipeline`](grii_slide_maker/songs/drive.py) / [`grii_slide_maker.songs.drive.save_images_from_google_folder_to_memory`](grii_slide_maker/songs/drive.py)
